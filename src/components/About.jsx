    ...
    <article className="pt-5">
      ...
      <section className="section drop-shadow-xl">
        <img
          ...
          alt="Restaurant "
          className="lg:w-1/2 rounded-lg object-cover shadow-md shadow-black/30"
        />
      ...
      <section className="section lg:!flex-row-reverse bg-gradient-to-bl from-yellow-500 via-pink-600 to-red-500 dropshadow-xl">
        <img
      ...
      <footer className="font-sans font-extralight shadow-black/30 shadow-inner bg-gradient-to-t  from-pink-600 to-red-500 flex flex-col items-center gap-10 px-5 py-10 text-white">
        ...
        <div className="flex flex-col lg:flex-row gap-10 h-full border-b border-white w-full pb-5">
          <ul className="text-white text-2xl flex flex-col lg:flex-row items-center lg:items-start justify-evenly gap-5  w-full">
        ...
        <ul className="flex flex-col lg:flex-row gap-5 my-0">
