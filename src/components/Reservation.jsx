...
const Reservation = () => {
  ...
  useEffect(()=>{
    const fetchReservation = async()=>{
      const response = await fetch(`https://gray-charming-viper.cyclic.app/record/reservations/${reservationId}`,{headers:{"Content-Type":"application/json"},method:"get"})
      if(!response.ok){
  ...
  const onSubmit = async(e)=>{
    ...
    const response = await fetch(`https://gray-charming-viper.cyclic.app/record/reservations`,{
