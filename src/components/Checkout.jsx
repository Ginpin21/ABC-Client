...
const Checkout = () => {
  ...
  const submitData = async (e)=>{
    ...
    const response = await fetch("https://gray-charming-viper.cyclic.app/record/orders",{
  ...
  useEffect(()=>{
    const fetchOrder = async()=>{
      const response = await fetch(`https://gray-charming-viper.cyclic.app/record/orders/${orderId}`,{headers:{"Content-Type":"application/json"},method:"get"})
      if(!response.ok){
        alert(response.statusText)
      }
      const data = await response.json()
