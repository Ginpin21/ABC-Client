...
const Disclaimer = () => {
  ...
  return (
    <footer className="flex flex-col items-center w-full bg-black/50 backdrop-blur-sm fixed bottom-0 z-50 text-white font-extralight p-5 md:text-2xl">
        ...
        <button className="btn md:!w-1/2" onClick={onClick}>Yes, I understand</button>
    </footer>
  )
}
